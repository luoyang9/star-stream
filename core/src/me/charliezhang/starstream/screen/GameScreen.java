...
import me.charliezhang.starstream.wave.WaveManager;
...
class GameScreen implements Screen
{
	...
	public void update(float delta) {
		...
		if(win)
		{
			...
			{
				game.setScreen(new WinScreen(game, background, manager.getScore(), manager.getMoney(), manager.getPlayer().getLives(), manager.getTime(), level));
				canDispose = true;
			}
			return;
		}
